...
class TaskService {
  async createTask(userId: string, taskData: Partial<ITask>): Promise<ITask> {
    ...
    console.log(`[TaskService] Tarefa criada com sucesso: ${task._id}`);
    return task;
  }
  ...
  async getTaskById(taskId: string, userId: string): Promise<ITask> {
    ...
    console.log(`[TaskService] Tarefa encontrada: ${task._id}`);
    return task;
  }
  ...
  async updateTask(taskId: string, userId: string, updateData: Partial<ITask>): Promise<ITask> {
    ...
    console.log(`[TaskService] Tarefa atualizada com sucesso: ${task._id}`);
    return task;
  }
  ...
  async partialUpdateTask(taskId: string, userId: string, updateData: Partial<ITask>): Promise<ITask> {
    ...
    console.log(`[TaskService] Tarefa atualizada parcialmente com sucesso: ${task._id}`);
    return task;
  }
  ...
  async deleteTask(taskId: string, userId: string): Promise<void> {
    ...
    console.log(`[TaskService] Tarefa deletada com sucesso: ${task._id}`);
  }
